...
/* Apply global rounding for main containers */
main.content, 
.account-box, 
.courses-box, 
.dashboard-box, 
...
/* Optional: soft shadow for floating feel */
main.content, 
.account-box, 
.courses-box, 
.dashboard-box, 
...
/* ================================
   Dark Theme – Page Scroll Navigator
   ================================ */
...
/* Scroll track in dark mode */
#scroll-track {
    background: rgba(255, 255, 255, 0.12);
}

/* Thumb – keep brand gold, add subtle glow for contrast */
#scroll-thumb {
    ...
    box-shadow:
        ...
        0 4px 12px rgba(178, 139, 0, 0.45);
}

/* Hover / active states still feel alive in dark mode */
#scroll-thumb:hover {
...
.site-header .header-logo {
    ...
    width: 50%;             /* scales relative to the container */
...
/* ===================== DARK THEME TEXT ALIGNMENT ===================== */
/* Default everything to left */
[data-theme="dark"] body {
...
[data-theme="dark"] .account-box ul,
[data-theme="dark"] .account-box li,
[data-theme="dark"] .courses-box p,
[data-theme="dark"] .courses-box ul,
[data-theme="dark"] .courses-box li,
[data-theme="dark"] .dashboard-box p,
[data-theme="dark"] .dashboard-box ul,
[data-theme="dark"] .dashboard-box li,
[data-theme="dark"] .admin-box p,
[data-theme="dark"] .admin-box ul,
[data-theme="dark"] .admin-box li,
[data-theme="dark"] .message-box p,
[data-theme="dark"] .message-box ul,
[data-theme="dark"] .message-box li,
[data-theme="dark"] .courses-list p,
[data-theme="dark"] .courses-list ul,
[data-theme="dark"] .courses-list li,
[data-theme="dark"] .add-course p,
[data-theme="dark"] .add-course ul,
[data-theme="dark"] .add-course li {
    text-align: left;
}
